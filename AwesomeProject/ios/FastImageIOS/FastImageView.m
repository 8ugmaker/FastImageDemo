...
- (void)setSource:(FastImageSource *)source {
    if (_source != source) {
        _source = source;
        _needsReload = YES;
    }
...
- (void)reloadImage
{
    ...
    if (_source) {
        ...
        switch (_source.cacheControl) {
            case FCacheControlWeb:
                options |= SDWebImageRefreshCached;
                break;
            case FCacheControlCacheOnly:
                options |= SDWebImageFromCacheOnly;
                break;
            case FCacheControlImmutable:
                break;
        }
...
- (void)downloadImage:(FastImageSource *) source options:(SDWebImageOptions) options context:(SDWebImageContext *)context {
